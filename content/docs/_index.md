...
Welcome to the official documentation for the [EnvyRP][home] FiveM Roleplay server. <br/>
The aim of the documenation is to help new players adjust and learn the features of EnvyRP.

For any questions or problems related to your experience on EnvyRP, feel free to
...
<div style="font-size: 0;">
  <div style="width: 50%; vertical-align: top; display: inline-block; font-size: 1.05rem; padding-right: 5px;">
    ...
    <div style="border: 1px solid lightgray; padding: 15px; margin-bottom: 5px;">
      ...
      <ul>
        <li><a href="/docs/getting-started">Getting used to EnvyRP</a></li>
  ...
  <div style="width: 50%; vertical-align: top; display: inline-block; font-size: 1.05rem;">
    <div style="border: 1px solid lightgray; padding: 15px; margin-bottom: 5px;">
      ...
      <ul>
        ...
        <li><a href="https://runtime.EnvyRP.net/doc/reference.html" target="_blank">Native functions reference</a></li>
